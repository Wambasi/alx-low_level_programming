...
/**
 * print_class _ prints the class of an ELF header
...
/**
 * print_versio - prints the version of an ELF header
 ...
 *
 * Decription: if the file cannot be closed- exit code 98
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
